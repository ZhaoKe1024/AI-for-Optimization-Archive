...
- Evolution of Heuristics: Towards Efficient Automatic Algorithm Design Using Large Language Model
    > [openreview link](https://openreview.net/forum?id=BwAkaxqiLB)
    > [Fei Liu](https://openreview.net/profile?id=~Fei_Liu14), [Tong Xialiang](https://openreview.net/profile?id=~Tong_Xialiang2), [Mingxuan Yuan](https://openreview.net/profile?id=~Mingxuan_Yuan1), [Xi Lin](https://openreview.net/profile?id=~Xi_Lin2), [Fu Luo](https://openreview.net/profile?id=~Fu_Luo1), [Zhenkun Wang](https://openreview.net/profile?id=~Zhenkun_Wang1), [Zhichao Lu](https://openreview.net/profile?id=~Zhichao_Lu1), [Qingfu Zhang](https://openreview.net/profile?id=~Qingfu_Zhang1)
...
## Math Modeling
- MM-Agent
    > NIPS 2025. MM-Agent: LLM as Agents for Real-world Mathematical Modeling Problem
    > SJTU. [Fan Liu](https://openreview.net/profile?id=~Fan_Liu5), [Zhe-Rui Yang](https://openreview.net/profile?id=~Zhe-Rui_Yang1), [Cancheng Liu](https://openreview.net/profile?id=~Cancheng_Liu1), [Tianrui SONG](https://openreview.net/profile?id=~Tianrui_SONG1), [Xiaofeng Gao](https://openreview.net/profile?id=~Xiaofeng_Gao2), [Hao Liu](https://openreview.net/profile?id=~Hao_Liu17)
    > NIPS 2025 [openreview link](https://openreview.net/forum?id=o8n5oNDsiq), [Github Link](https://github.com/usail-hkust/LLM-MM-Agent), [ICML 2025 Workshop Page](https://icml.cc/virtual/2025/52422), [arXiv Link](https://arxiv.org/abs/2505.14148)
- MATHMO: Automated Mathematical Modeling Through Adaptive Search.
    > ICLR2025 [openreview link](https://openreview.net/forum?id=t2fZ2GOwAT)

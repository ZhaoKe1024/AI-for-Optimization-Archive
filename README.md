...
## Survey
[github link](https://github.com/BeinuoYang/Awesome-LLM4Opt)
...
- 2026.05 Strategy-Aware Optimization Modeling with Reasoning LLMs
    ...
    > Github: https://github.com/rachhhhing/SAGE

- 2026.05 ORPilot: A Production-Oriented Agentic LLM-for-OR Tool for Optimization Modeling
    > https://arxiv.org/abs/2605.02728v1
    > Authors: Guangrui Xie

- 2026.04 NED-Tree: Bridging the Semantic Gap with Nonlinear Element Decomposition Tree for LLM Nonlinear Optimization Modeling
    > [arxiv link](https://arxiv.org/abs/2604.01588v1)

- 2026.04 AutoOR
    > AutoOR: Scalably Post-training LLMs to Autoformalize Operations Research Problems
    > https://arxiv.org/pdf/2604.16804
...
- 2026.04 Agora-Opt
    ...
    > https://arxiv.org/abs/2604.25847v1
    > Jianghao Lin, Zi Ling, Chenyu Zhou, Tianyi Xu, Ruoqing Jiang, Zizhuo Wang, Dongdong Ge

- 2026.02 OptiRepair: Closed-Loop Diagnosis and Repair of Supply Chain Optimization Models with LLM Agents
    > [arXiv link](https://arxiv.org/abs/2602.19439) 
    > Authors: Ruicheng Ao, David Simchi-Levi, Xinshang Wang
    > Date: 2602.19439
- 2026.02 ReLoop: Structured Modeling and Behavioral Verification for Reliable LLM-Based Optimization
    > [arXiv link](https://arxiv.org/abs/2602.15983) 
    > Authors: Junbo Jacob Lian, Yujun Sun, Huiling Chen, Chaoyu Zhang, Chung-Piaw Teo
    > Date: 2602.15983
- 2026.02 EvoOpt-LLM: Evolving industrial optimization models with large language models
    > [arXiv link](https://arxiv.org/abs/2602.01082)
    > Authors: Yiliu He, Tianle Li, Binghao Ji, Zhiyuan Liu, Di Huang
    > Date: 2602.01082

- 2026.02 Canonical Intermediate Representation for LLM-based optimization problem formulation and code generation
    > [arxiv link](https://arxiv.org/abs/2602.02029)

- 2026.01 LEAN-LLM-OPT
    > arXiv 2026: LLM for Large-Scale Optimization Model Auto-Formulation: Bridging Flexibility and Standardization via Agentic Workflow. Kuo Liang, Yuhang Lu, Jianming Mao, Shuyi Sun, Chunwei Yang, Congcong Zeng, Xiao Jin, [Hanzhang Qin](https://openreview.net/profile?id=~Hanzhang_Qin1), Ruihao Zhu, Chung-Piaw Teo. arXiv [link](https://arxiv.org/abs/2601.09635)
...
- 2026.01 NEMO: Execution-Aware Optimization Modeling via Autonomous Coding Agents
    ...
    > Date: 2601.21372
- 2025.12 LM4RA, LM4Opt-RA, LLM-LM4Opt-RA
 > LM4Opt-RA: A Multi-Candidate LLM Framework with Structured Ranking for Automating Network Resource Allocation
 > https://arxiv.org/abs/2512.00039v1
 > However, existing benchmarks and datasets cannot address the complexities of such problems with dynamic environments, interdependent variables, and heterogeneous constraints. To address this gap, we introduce NL4RA, a curated dataset comprising 50 resource allocation optimization problems formulated as LP, ILP, and MILP.
...
- 2025.10 SAC-OPT
    ...
    > Authors: Yansen Zhang, Qingcan Kang, Yujie Chen, Yufei Wang, Xiongwei Han, Tao Zhong, Mingxuan Yuan, Chen Ma. (CityUHK, Huawei)
- 2025.10 OptiTree: Hierarchical Thoughts Generation with Tree Search for LLM Optimization Modeling
...
- 2025.09 OptiMind
    > OptiMind: Teaching LLMs to Think Like Optimization Experts. [arxiv link](https://arxiv.org/abs/2509.22979).
    ...
    > ICLR 2026 Reject [openreview link](https://openreview.net/forum?id=CvwLtwlraW).
- 2025.07 Autoformulation of Mathematical Optimization Models Using LLMs
    > ICLR 2025 Reject , [openreview link](https://openreview.net/forum?id=107ZsHD8h7)
    > ICML 2025 Accept, [openreview link](https://openreview.net/forum?id=33YrT1j0O0)
    > [arXiv link](Autoformulation of Mathematical Optimization Models Using LLMs)
    > [Nicolás Astorga](https://openreview.net/profile?id=~Nicol%C3%A1s_Astorga1), [Tennison Liu](https://openreview.net/profile?id=~Tennison_Liu1), [Yuanzhang Xiao](https://openreview.net/profile?id=~Yuanzhang_Xiao1), [Mihaela van der Schaar](https://openreview.net/profile?id=~Mihaela_van_der_Schaar2)
- 2025.05 LLM-OptiRA: LLM-Driven Optimization of Resource Allocation for Non-Convex Problems in Wireless Communications
    > [arXvi link](https://arxiv.org/abs/2505.02091)
    > Xinyue Peng, Yanming Liu, Yihan Cang, Chaoqun Cao, Ming Chen
- 2025.04 EOR, ICLR2025, Decision Information Meets Large Language Models: The Future of Explainable Operations Research
...
- 2024.10 ICLR2025 Planning Anything with Rigor: General-Purpose Zero-Shot Planning with LLM-based Formalized Programming.
    > [arXiv link](https://arxiv.org/abs/2410.12112). Github: [link1](https://github.com/yih301/LLMFP), [link2](https://github.com/Rmcrow/LLMFP-llm-planning). Blog: [link](https://news.mit.edu/2025/researchers-teach-llms-to-solve-complex-planning-challenges-0402)
- 2024.07 OptiMUS
...
- 2026.01 NC2C: Automated Convexification of Generic Non-Convex Optimization Problems
  ...
  > Authors: Xinyue Peng, Yanming Liu, Yihan Cang, Yuwei Zhang
  > we propose NC2C, an LLM-based end-to-end automated framework designed to transform generic non-convex optimization problems into solvable convex forms using large language models. NC2C leverages LLMs' mathematical reasoning capabilities to autonomously detect non-convex components, select optimal convexification strategies, and generate rigorous convex equivalents. The framework integrates symbolic reasoning, adaptive transformation techniques, and iterative validation, equipped with error correction loops and feasibility domain correction mechanisms to ensure the robustness and validity of transformed problems

- 2025.10 ConstraintLLM
...
## SFT
- 2026.04 OR-PRM: A Process Reward Model for Algorithmic Problem in Operations Research.
    > ICLR2026 Accept
    > [openreview link](https://openreview.net/forum?id=tFEAzYdz92)
- 2026.02 Automated Optimization Modeling via a Localizable Error-Driven Perspective
    ...
    > Date: 2602.11164
- 2025.12 MURKA: Multi-Reward Reinforcement Learning with Knowledge Alignment for Optimization Tasks
...
- 2025.10 OR-Toolformer: Modeling and Solving Operations Research Problems with Tool Augmented Large Language Models
...
- 2025.06 Step-OPT
    ...
    > iclr 2025 reject? Evo-Step: Evolutionary Generation and Stepwise Validation for Optimizing LLMs in OR [openreview link](https://openreview.net/forum?id=aapUBU9U0D). [Yang Wu](https://openreview.net/profile?id=~Yang_Wu8), [Yifan Zhang](https://openreview.net/profile?id=~Yifan_Zhang2), [Yurong Wu](https://openreview.net/profile?id=~Yurong_Wu2), [Yuran Wang](https://openreview.net/profile?id=~Yuran_Wang8), [Junkai Zhang](https://openreview.net/profile?id=~Junkai_Zhang3), [Jian Cheng](https://openreview.net/profile?id=~Jian_Cheng7)
- 2025.06 ORMind: A Cognitive-Inspired End-to-End Reasoning Framework for Operations Research
    > [arXiv link](https://arxiv.org/abs/2506.01326)
...
- 2023.12 CAFA: Coding as Auto-Formulation Can Boost Large Language Models in Solving Linear Programming Problem
...
- 2026.02  Beyond Pass-by-Pass Optimization: Intent-Driven IR Optimization with Large Language Models
    ...
    > Date: 2602.18511
- 2026.02 ProOPF: Benchmarking and Improving LLMs for Professional-Grade Power Systems Optimization Modeling
...
## Datasets
- 2026.01 Large-Scale-OR (LEAN-LLM-OPT)

- 2025.08 OptiTrust 
    > Toward a Trustworthy Optimization Modeling Agent via Verifiable Synthetic Data Generation, Vinicius Lima, Dzung T. Phan, Jayant Kalagnanam, Dhaval Patel, Nianjun Zhou (us.IBM.com) [arXiv link](https://arxiv.org/abs/2508.03117). Vinicius Lima, Dzung T. Phan, Jayant Kalagnanam, Dhaval Patel, Nianjun Zhou.
...
- 2025.10 ORGEval: Graph-Theoretic Evaluation of LLMs in Optimization Modeling
    > [arXiv link](https://arxiv.org/abs/2510.27610), [Huggingface link](https://huggingface.co/papers/2510.27610)
    > CUHK, Zhuohan Wang, Ziwei Zhu, Ziniu Li, Congliang Chen, Yizhou Han, Yufeng Lin, Zhihang Lin, Angyang Gu, Xinglin Hu, Ruoyu Sun, [Tian Ding](https://openreview.net/profile?id=~Tian_Ding1)
- 2025.02 EquivaMap: Leveraging LLMs for Automatic Equivalence Checking of Optimization Formulations
    > ICML2025 Accept . [ICML page](https://icml.cc/virtual/2025/poster/44297). [openreview link](https://openreview.net/forum?id=jaCD2nEpyr). [arXiv link](https://arxiv.org/abs/2502.14760). [Github link](https://github.com/HumainLab/EquivaMap). [Huggingface link](https://huggingface.co/papers/2502.14760)
    > [Haotian Zhai](https://openreview.net/profile?id=~Haotian_Zhai1), [Connor Lawless](https://openreview.net/profile?id=~Connor_Lawless1), [Ellen Vitercik](https://openreview.net/profile?id=~Ellen_Vitercik1), [Liu Leqi](https://openreview.net/profile?id=~Liu_Leqi1)
- Coherent Local Explanations for Mathematical Optimization
    > ICLR 2026 Reject
    > [openreview link](https://openreview.net/forum?id=vIcqXbhU0Y)
- ALIGNING LLMS WITH GRAPH NEURAL SOLVERS FOR COMBINATORIAL OPTIMIZATION
    > ICLR 2026 Reject, [openreview link](https://openreview.net/forum?id=KSfLDk3jxI)


## DeepLearning for Optimization
- 2025.08 Efficient Heuristics Generation for Solving Combinatorial Optimization Problems Using Large Language Models, [ACM KDD link](https://dl.acm.org/doi/10.1145/3711896.3736923)



- 2025.07 BPP-Search: Enhancing Tree of Thought Reasoning for Mathematical Modeling Problem Solving
...
- 2020 TPAMI2020. The Gap of Semantic Parsing: A Survey on Automatic Math Word Problem Solvers. Dongxiang Zhang, Lei Wang, Luming Zhang, Bing Tian Dai, Heng Tao Shen.
- 2019.07 ACL2019. Modeling Intra-Relation in Math Word Problems with Different Functional Multi-Head Attentions. Jierui Li, Lei Wang, Jipeng Zhang, Yan Wang, Bing Tian Dai, [Dongxiang Zhang](https://openreview.net/profile?id=~Dongxiang_Zhang2)
...
- 2026.01 Evolving Interdependent Operators with Large Language Models for Multi-Objective Combinatorial Optimization
    > [arXiv link](https://arxiv.org/abs/2601.17899) 
    > Authors: Junhao Qiu, Xin Chen, Liang Ge, Liyong Lin, Zhichao Lu, Qingfu Zhang
    > Date: 2601.17899

- 2025.08 Efficient Heuristics Generation for Solving Combinatorial Optimization Problems Using Large Language Models. [ACM KDD link](https://dl.acm.org/doi/10.1145/3711896.3736923). Xuan Wu, Di Wang, Chunguo Wu, Lijie Wen, Chunyan Miao, Yubin Xiao, You Zhou.
...
- Rethinking Neural Multi-Objective Combinatorial Optimization via Neat Weight Embedding
    > [openreview link](https://openreview.net/forum?id=GM7cmQfk2F)
    > [Jinbiao Chen](https://openreview.net/profile?id=~Jinbiao_Chen1), [Zhiguang Cao](https://openreview.net/profile?id=~Zhiguang_Cao1), [Jiahai Wang](https://openreview.net/profile?id=~Jiahai_Wang1), [Yaoxin Wu](https://openreview.net/profile?id=~Yaoxin_Wu2), [Hanzhang Qin](https://openreview.net/profile?id=~Hanzhang_Qin1), [Zizhen Zhang](https://openreview.net/profile?id=~Zizhen_Zhang1), [Yue-Jiao Gong](https://openreview.net/profile?id=~Yue-Jiao_Gong1)
...
# LLMs Survey
- 2025.10 PRM
    > A Survey of Process Reward Models: From Outcome Signals to Process Supervisions for Large Language Models. [arxiv link](https://arxiv.org/abs/2510.08049). Congming Zheng, Jiachen Zhu, Zhuoying Ou, Yuxiang Chen, Kangning Zhang, Rong Shan, Zeyu Zheng, Mengyue Yang, Jianghao Lin, Yong Yu, Weinan Zhang
    > The Lessons of Developing Process Reward Models in Mathematical Reasoning. [arXiv link](https://arxiv.org/abs/2501.07301)
    > Dynamic and Generalizable Process Reward Modeling. [ACL pdf link](https://aclanthology.org/2025.acl-long.212.pdf)

# Some LLMs for Math
- 2025.01 The Lessons of Developing Process Reward Models in Mathematical Reasoning. [arxiv link](https://arxiv.org/abs/2501.07301)
